...
let marca;
let tiempoLimitefondo = 1000; //5secs (despues de hacer ruido)
let tiempoLimitebarra = 1000; //10secs (despues de hacer ruido o si no hago ruido)
let tiempoLimiteplumas = 1000; //10secs (despues de hacer ruido o si no hago ruido)
